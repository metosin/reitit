(defproject metosin/reitit-parent "0.3.5"
  ...
  :managed-dependencies [[metosin/reitit "0.3.5"]
                         [metosin/reitit-core "0.3.5"]
                         [metosin/reitit-dev "0.3.5"]
                         [metosin/reitit-spec "0.3.5"]
                         [metosin/reitit-schema "0.3.5"]
                         [metosin/reitit-ring "0.3.5"]
                         [metosin/reitit-middleware "0.3.5"]
                         [metosin/reitit-http "0.3.5"]
                         [metosin/reitit-interceptors "0.3.5"]
                         [metosin/reitit-swagger "0.3.5"]
                         [metosin/reitit-swagger-ui "0.3.5"]
                         [metosin/reitit-frontend "0.3.5"]
                         [metosin/reitit-sieppari "0.3.5"]
                         [metosin/reitit-pedestal "0.3.5"]
