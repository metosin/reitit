(defproject metosin/reitit-parent "0.4.0"
  ...
  :managed-dependencies [[metosin/reitit "0.4.0"]
                         [metosin/reitit-core "0.4.0"]
                         [metosin/reitit-dev "0.4.0"]
                         [metosin/reitit-spec "0.4.0"]
                         [metosin/reitit-malli "0.4.0"]
                         [metosin/reitit-schema "0.4.0"]
                         [metosin/reitit-ring "0.4.0"]
                         [metosin/reitit-middleware "0.4.0"]
                         [metosin/reitit-http "0.4.0"]
                         [metosin/reitit-interceptors "0.4.0"]
                         [metosin/reitit-swagger "0.4.0"]
                         [metosin/reitit-swagger-ui "0.4.0"]
                         [metosin/reitit-frontend "0.4.0"]
                         [metosin/reitit-sieppari "0.4.0"]
                         [metosin/reitit-pedestal "0.4.0"]
