(defproject metosin/reitit-parent "0.5.16"
  ...
  :managed-dependencies [[metosin/reitit "0.5.16"]
                         [metosin/reitit-core "0.5.16"]
                         [metosin/reitit-dev "0.5.16"]
                         [metosin/reitit-spec "0.5.16"]
                         [metosin/reitit-malli "0.5.16"]
                         [metosin/reitit-schema "0.5.16"]
                         [metosin/reitit-ring "0.5.16"]
                         [metosin/reitit-middleware "0.5.16"]
                         [metosin/reitit-http "0.5.16"]
                         [metosin/reitit-interceptors "0.5.16"]
                         [metosin/reitit-swagger "0.5.16"]
                         [metosin/reitit-swagger-ui "0.5.16"]
                         [metosin/reitit-frontend "0.5.16"]
                         [metosin/reitit-sieppari "0.5.16"]
